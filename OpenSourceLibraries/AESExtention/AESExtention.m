...
+ (NSString *) base64EncodeData2: (NSData *) objData { // default
//    NSLog(@"1");
...
+ (NSString*) aesEncryptStringWithKey:(NSString *)key text:(NSString*)textString{
...
//    NSString *key = [NSString stringWithFormat:@"#TALKTODAEWOONG$"];
    ...
    return [self base64EncodeData:aes128EncData];
}
